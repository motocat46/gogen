...
func NewRegistry() *Registry {
	...
	r.Register(model.KindBasic, &BasicGenerator{})
	r.Register(model.KindPointer, &BasicGenerator{})  // 指针类型复用 basic 模板
	r.Register(model.KindStruct, &BasicGenerator{})   // 结构体字段复用 basic 模板
	r.Register(model.KindGeneric, &BasicGenerator{})  // 泛型类型复用 basic 模板
